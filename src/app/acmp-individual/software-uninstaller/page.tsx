...
// Software Uninstaller module details
const softwareUninstallerModule = {
  id: 'software-uninstaller',
  title: 'Software Uninstaller',
  description: 'Intelligente Software-Deinstallation mit Cleanup-Funktionen - Saubere Entfernung von Programmen',
  icon: Trash2,
  category: 'Admin Tools',
  available: true,
  features: [
    'Intelligente Software-Erkennung',
    'Saubere Deinstallation mit Cleanup',
    'Registry-Bereinigung',
    'Datei- und Ordner-Entfernung',
    'Abhängigkeits-Analyse',
    'Batch-Deinstallation möglich',
    'Rollback bei Problemen',
    'Deinstallations-Berichterstattung'
  ],
  detailedDescription: 'Das Software Uninstaller Modul bietet eine intelligente und saubere Deinstallation von Software. Es erkennt automatisch Deinstallationsprogramme, bereinigt Registry-Einträge und entfernt verbleibende Dateien und Ordner.',
  technicalSpecs: [
    'MSI- und EXE-Deinstallations-Unterstützung',
    'Registry-Scanning und -Cleanup',
    'Datei-System Analyse',
    'UninstallString Parsing',
    'Abhängigkeits-Mapping',
    'Silent-Deinstallation Optionen',
    'Progress-Tracking und Logging',
    'Error-Recovery Mechanismen'
  ],
  useCases: [
    'Saubere Software-Entfernung',
    'System-Bereinigung vor Migration',
    'Lizenz-Management und Compliance',
    'Troubleshooting von Software-Konflikten'
  ],
  screenshots: [
    {
      title: 'Software-Übersicht',
      description: 'Übersicht aller installierten Programme',
      image: '/images/acmp/uninstaller/overview.png'
    },
    {
      title: 'Deinstallations-Optionen',
      description: 'Konfigurierbare Deinstallations-Optionen',
      image: '/images/acmp/uninstaller/options.png'
    },
    {
      title: 'Cleanup-Bericht',
      description: 'Detaillierter Bericht über bereinigte Elemente',
      image: '/images/acmp/uninstaller/cleanup.png'
    }
  ],
  pricing: {
    monthly: '42',
  ...
  requirements: [
    ...
    'Datei-System Schreibrechte',
    'Deinstallations-Berechtigung'
  ]
};

export default function SoftwareUninstallerPage() {
  return (
    <ModuleLayout
      module={softwareUninstallerModule}
      modules={acmpIndividualModules}
      sidebarTitle="ACMP Individual Module"
      baseUrl="/acmp-individual"
      backUrl="/acmp-individual"
      backLabel="Zurück zur Übersicht"
      currentModule="software-uninstaller"
    />
  );
}