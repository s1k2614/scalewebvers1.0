...
// Next Free Computername module details
const nextFreeComputernameModule = {
  id: 'next-free-computername',
  title: 'Next Free Computername',
  description: 'Automatische Generierung verfügbarer Computernamen - Intelligente Namensvergabe für neue Geräte',
  icon: Computer,
  category: 'Admin Tools',
  available: true,
  features: [
    'Automatische Namensgenerierung',
    'Active Directory Namensraum-Überprüfung',
    'Konfigurierbare Namensmuster',
    'Standort-basierte Präfixe',
    'Abteilungs-spezifische Namensräume',
    'Namenskonflikt-Erkennung',
    'Historische Namensverfolgung',
    'Bulk-Namensgenerierung'
  ],
  detailedDescription: 'Das Next Free Computername Modul generiert automatisch verfügbare Computernamen basierend auf Ihren vordefinierten Namensmustern. Es überprüft die Active Directory Umgebung und stellt sicher, dass keine Namenskonflikte entstehen.',
  technicalSpecs: [
    'Active Directory LDAP-Abfragen',
    'Regex-basierte Namensmuster',
    'Standort- und Abteilungs-Mapping',
    'Konflikt-Erkennung und -Auflösung',
    'Datenbank-basierte Historie',
    'API für externe Integration',
    'Validierung und Formatierung',
    'Multi-Domain Unterstützung'
  ],
  useCases: [
    'Automatische Computer-Benennung bei Neueinrichtung',
    'Standardisierung von Namenskonventionen',
    'Standort-spezifische Namensräume',
    'Bulk-Computer-Registrierung'
  ],
  screenshots: [
    {
      title: 'Namensgenerator',
      description: 'Automatische Generierung verfügbarer Namen',
      image: '/images/acmp/computername/generator.png'
    },
    {
      title: 'Namensmuster-Konfiguration',
      description: 'Konfiguration von Namensmustern und Regeln',
      image: '/images/acmp/computername/patterns.png'
    },
    {
      title: 'Namensraum-Übersicht',
      description: 'Übersicht über verwendete und verfügbare Namen',
      image: '/images/acmp/computername/namespace.png'
    }
  ],
  pricing: {
    monthly: '29',
  ...
  requirements: [
    ...
    'Leserechte für Computer-Objekte',
    'Schreibrechte für neue Computer-Objekte',
    'Netzwerk-Zugang zu Domain-Controllern'
  ]
};

export default function NextFreeComputernamePage() {
  return (
    <ModuleLayout
      module={nextFreeComputernameModule}
      modules={acmpIndividualModules}
      sidebarTitle="ACMP Individual Module"
      baseUrl="/acmp-individual"
      backUrl="/acmp-individual"
      backLabel="Zurück zur Übersicht"
      currentModule="next-free-computername"
    />
  );
}