...
import { 
  ...
  Calendar, MessageSquare, ArrowRight, Cog
} from 'lucide-react'
...
export default function ImplementationPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <Hero 
        title="Professionelle System-Implementierung"
        subtitle="Expertenwissen für erfolgreiche IT-Projekte - von der Planung bis zum Go-Live"
