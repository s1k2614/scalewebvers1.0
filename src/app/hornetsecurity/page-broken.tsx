...
const ThreatBlockingDiagram = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 text-white relative overflow-hidden">
      ...
      <div className="relative h-32 bg-gray-700 rounded-xl mb-6 overflow-hidden">
        {/* Progress Track */}
        ...
        <motion.div
          className={`absolute top-1/2 transform -translate-y-1/2 rounded-full p-2 ${
            currentEmailType === 'threat' ? 'bg-red-500' : 'bg-red-500'
          }`}
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <motion.div
            className={`bg-orange-500 rounded-full p-3 ${
              (isBlocked || (currentPhase === 1 && emailPosition >= 40)) ? 'ring-4 ring-orange-300' : ''
            }`}
        ...
        <div className="absolute top-1/2 right-4 transform -translate-y-1/2">
          <motion.div 
            className={`rounded-full p-2 ${isDelivered ? 'bg-green-500 ring-4 ring-green-300' : 'bg-gray-500'}`}
        ...
        <AnimatePresence>
          {isBlocked && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-red-500 text-white px-4 py-2 rounded-lg font-bold text-sm"
            >
              🛡️ BLOCKIERT!
            </motion.div>
          )}
        ...
        <AnimatePresence>
          {isDelivered && (
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0 }}
              className="absolute top-1/2 right-16 transform -translate-y-1/2 bg-green-500 text-white px-4 py-2 rounded-lg font-bold text-sm"
            >
              ✅ ZUGESTELLT!
            </motion.div>
          )}
      ...
      {currentPhase === 1 && emailPosition >= 40 && (
        ...
        >
          <h4 className="font-semibold mb-2 text-orange-400">🔍 Sicherheitsanalyse läuft...</h4>
      ...
      {(isBlocked || isDelivered) && (
        <motion.div
          ...
          className={`rounded-lg p-4 mb-4 ${
            currentEmailType === 'threat' ? 'bg-red-900/30 border border-red-500' : 'bg-green-900/30 border border-green-500'
          }`}
        >
          <h4 className="font-semibold mb-3 flex items-center gap-2">
            {currentEmailType === 'threat' ? (
              <>
                ...
                <span className="text-red-400">Bedrohungsanalyse</span>
              </>
            ) : (
              <>
                <Mail className="w-5 h-5 text-green-400" />
                <span className="text-green-400">Sichere E-Mail Details</span>
              </>
            )}
          </h4>
          ...
          {currentEmailType === 'threat' ? (
            <div className="space-y-2 text-sm">
              ...
              <ul className="ml-4 space-y-1 text-red-300">
            ...
            <div className="space-y-2 text-sm">
              ...
              <ul className="ml-4 space-y-1 text-green-300">
          ...
          {getCurrentPhases().map((_, index) => (
            <div
              ...
              className={`w-3 h-3 rounded-full transition-colors duration-300 ${
                index <= currentPhase ? 'bg-orange-400' : 'bg-gray-600'
              }`}
            />
          ))}
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="mb-16"
            >
              <div className="inline-flex items-center bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 text-white px-8 py-4 rounded-full shadow-xl">
              ...
              <p className="text-gray-600 mt-3 text-lg">
                ...
                <Link href="/services" className="text-orange-600 hover:text-orange-700 underline font-semibold">
                ...
                return (
                  <div key={module.id} className="relative">
                    ...
                    <motion.button
                      ...
                      className={`relative overflow-hidden rounded-2xl p-6 transition-all duration-300 hover:scale-105 bg-gradient-to-r ${module.color} ${
                    ...
                    >
                      <div className="text-white text-center">
                        ...
                        <p className="text-sm opacity-90 text-white line-clamp-3">
                          {module.description}
                        </p>
                      </div>
                    </motion.button>
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-2 gap-2">
                                    <div className="bg-green-700 rounded-lg p-3 text-center">
                                      ...
                                      <div className="text-xs text-green-300">Konform</div>
                                    </div>
                                    <div className="bg-green-700 rounded-lg p-3 text-center">
                                      <CheckCircle className="w-6 h-6 mx-auto mb-1" />
                            ...
                            {module.id === 'ai-cyber-assistant' && (
                              <div className="bg-gradient-to-br from-indigo-900 to-purple-900 rounded-2xl p-6 text-white">
                                ...
                                <div className="space-y-4">
                                  ...
                                  {/* Learning Status */}
                                  <div className="bg-gradient-to-r from-indigo-800 to-purple-800 rounded-lg p-3 text-center">
